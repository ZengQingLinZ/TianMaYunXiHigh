...
#import "zp02yx_xzmbhWMMenuView.h"
#import "zp02yx_xzmbhWMScrollView.h"

@class zp02yx_xzmbhWMPageController;

/*
 *  WMPageController 的缓存设置，默认缓存为无限制，当收到 memoryWarning 时，会自动切换到低缓存模式 (zp02yx_xzmbhWMPageControllerCachePolicyLowMemory)，并在一段时间后切换到 High .
    收到多次警告后，会停留在到 zp02yx_xzmbhWMPageControllerCachePolicyLowMemory 不再增长
 *
 ...
 */
typedef NS_ENUM(NSInteger, zp02yx_xzmbhWMPageControllerCachePolicy) {
    zp02yx_xzmbhWMPageControllerCachePolicyDisabled   = -1,  // Disable Cache
    zp02yx_xzmbhWMPageControllerCachePolicyNoLimit    = 0,   // No limit
    zp02yx_xzmbhWMPageControllerCachePolicyLowMemory  = 1,   // Low Memory but may block when scroll
    zp02yx_xzmbhWMPageControllerCachePolicyBalanced   = 3,   // Balanced ↑ and ↓
...
extern NSString *const zp02yx_xzmbhWMControllerDidAddToSuperViewNotification;
extern NSString *const zp02yx_xzmbhWMControllerDidFullyDisplayedNotification;
 ...
 */
- (NSInteger)numbersOfChildControllersInPageController:(zp02yx_xzmbhWMPageController *)pageController;
 ...
 */
- (__kindof UIViewController *)pageController:(zp02yx_xzmbhWMPageController *)pageController viewControllerAtIndex:(NSInteger)index;
 ...
 */
- (NSString *)pageController:(zp02yx_xzmbhWMPageController *)pageController titleAtIndex:(NSInteger)index;
 ...
 */
- (CGRect)pageController:(zp02yx_xzmbhWMPageController *)pageController preferredFrameForContentView:(zp02yx_xzmbhWMScrollView *)contentView;
 ...
 */
- (CGRect)pageController:(zp02yx_xzmbhWMPageController *)pageController preferredFrameForMenuView:(zp02yx_xzmbhWMMenuView *)menuView;
 ...
 */
- (void)pageController:(zp02yx_xzmbhWMPageController *)pageController lazyLoadViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(zp02yx_xzmbhWMPageController *)pageController willCachedViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(zp02yx_xzmbhWMPageController *)pageController willEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(zp02yx_xzmbhWMPageController *)pageController didEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;

@end

@interface zp02yx_xzmbhWMPageController : UIViewController <WMMenuViewDelegate, WMMenuViewDataSource, UIScrollViewDelegate, WMPageControllerDataSource, WMPageControllerDelegate>
 ...
 */
@property (nonatomic, assign) zp02yx_xzmbhWMMenuViewStyle menuViewStyle;

@property (nonatomic, assign) zp02yx_xzmbhWMMenuViewLayoutMode menuViewLayoutMode;
...
/** 顶部导航栏 */
@property (nonatomic, nullable, weak) zp02yx_xzmbhWMMenuView *menuView;

/** 内部容器 */
@property (nonatomic, nullable, weak) zp02yx_xzmbhWMScrollView *scrollView;
