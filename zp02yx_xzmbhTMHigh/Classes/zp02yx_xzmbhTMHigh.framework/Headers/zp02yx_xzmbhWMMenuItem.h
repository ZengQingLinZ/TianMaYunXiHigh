...
@class zp02yx_xzmbhWMMenuItem;

typedef NS_ENUM(NSUInteger, zp02yx_xzmbhWMMenuItemState) {
    zp02yx_xzmbhWMMenuItemStateSelected,
    zp02yx_xzmbhWMMenuItemStateNormal,
};

NS_ASSUME_NONNULL_BEGIN
@protocol WMMenuItemDelegate <NSObject>
@optional
- (void)didPressedMenuItem:(zp02yx_xzmbhWMMenuItem *)menuItem;
@end

@interface zp02yx_xzmbhWMMenuItem : UILabel
