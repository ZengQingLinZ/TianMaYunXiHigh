...
#import "zp02yx_xzmbWMMenuView.h"
#import "zp02yx_xzmbWMScrollView.h"

@class zp02yx_xzmbWMPageController;

/*
 *  WMPageController 的缓存设置，默认缓存为无限制，当收到 memoryWarning 时，会自动切换到低缓存模式 (zp02yx_xzmbWMPageControllerCachePolicyLowMemory)，并在一段时间后切换到 High .
    收到多次警告后，会停留在到 zp02yx_xzmbWMPageControllerCachePolicyLowMemory 不再增长
 *
 ...
 */
typedef NS_ENUM(NSInteger, zp02yx_xzmbWMPageControllerCachePolicy) {
    zp02yx_xzmbWMPageControllerCachePolicyDisabled   = -1,  // Disable Cache
    zp02yx_xzmbWMPageControllerCachePolicyNoLimit    = 0,   // No limit
    zp02yx_xzmbWMPageControllerCachePolicyLowMemory  = 1,   // Low Memory but may block when scroll
    zp02yx_xzmbWMPageControllerCachePolicyBalanced   = 3,   // Balanced ↑ and ↓
    zp02yx_xzmbWMPageControllerCachePolicyHigh       = 5    // High
};
...
extern NSString *const zp02yx_xzmbWMControllerDidAddToSuperViewNotification;
extern NSString *const zp02yx_xzmbWMControllerDidFullyDisplayedNotification;
 ...
 */
- (NSInteger)numbersOfChildControllersInPageController:(zp02yx_xzmbWMPageController *)pageController;
 ...
 */
- (__kindof UIViewController *)pageController:(zp02yx_xzmbWMPageController *)pageController viewControllerAtIndex:(NSInteger)index;
 ...
 */
- (NSString *)pageController:(zp02yx_xzmbWMPageController *)pageController titleAtIndex:(NSInteger)index;
 ...
 */
- (CGRect)pageController:(zp02yx_xzmbWMPageController *)pageController preferredFrameForContentView:(zp02yx_xzmbWMScrollView *)contentView;
 ...
 */
- (CGRect)pageController:(zp02yx_xzmbWMPageController *)pageController preferredFrameForMenuView:(zp02yx_xzmbWMMenuView *)menuView;
 ...
 */
- (void)pageController:(zp02yx_xzmbWMPageController *)pageController lazyLoadViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(zp02yx_xzmbWMPageController *)pageController willCachedViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(zp02yx_xzmbWMPageController *)pageController willEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(zp02yx_xzmbWMPageController *)pageController didEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;

@end

@interface zp02yx_xzmbWMPageController : UIViewController <WMMenuViewDelegate, WMMenuViewDataSource, UIScrollViewDelegate, WMPageControllerDataSource, WMPageControllerDelegate>
...
@property (nonatomic, assign) zp02yx_xzmbWMPageControllerCachePolicy cachePolicy;
...
/** 顶部导航栏 */
@property (nonatomic, nullable, weak) zp02yx_xzmbWMMenuView *menuView;

/** 内部容器 */
@property (nonatomic, nullable, weak) zp02yx_xzmbWMScrollView *scrollView;
