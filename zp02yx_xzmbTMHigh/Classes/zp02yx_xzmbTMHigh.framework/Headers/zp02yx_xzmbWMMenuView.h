...
#import "zp02yx_xzmbWMMenuItem.h"
#import "zp02yx_xzmbWMProgressView.h"
@class zp02yx_xzmbWMMenuView;
...
@optional
- (BOOL)menuView:(zp02yx_xzmbWMMenuView *)menu shouldSelesctedIndex:(NSInteger)index;
- (void)menuView:(zp02yx_xzmbWMMenuView *)menu didSelesctedIndex:(NSInteger)index currentIndex:(NSInteger)currentIndex;
- (CGFloat)menuView:(zp02yx_xzmbWMMenuView *)menu widthForItemAtIndex:(NSInteger)index;
- (CGFloat)menuView:(zp02yx_xzmbWMMenuView *)menu itemMarginAtIndex:(NSInteger)index;
- (CGFloat)menuView:(zp02yx_xzmbWMMenuView *)menu titleSizeForState:(WMMenuItemState)state atIndex:(NSInteger)index;
- (UIColor *)menuView:(zp02yx_xzmbWMMenuView *)menu titleColorForState:(WMMenuItemState)state atIndex:(NSInteger)index;
- (void)menuView:(zp02yx_xzmbWMMenuView *)menu didLayoutItemFrame:(zp02yx_xzmbWMMenuItem *)menuItem atIndex:(NSInteger)index;
@end

@protocol WMMenuViewDataSource <NSObject>

@required
- (NSInteger)numbersOfTitlesInMenuView:(zp02yx_xzmbWMMenuView *)menu;
- (NSString *)menuView:(zp02yx_xzmbWMMenuView *)menu titleAtIndex:(NSInteger)index;
 ...
 */
- (UIView *)menuView:(zp02yx_xzmbWMMenuView *)menu badgeViewAtIndex:(NSInteger)index;
 ...
 */
- (zp02yx_xzmbWMMenuItem *)menuView:(zp02yx_xzmbWMMenuView *)menu initialMenuItem:(zp02yx_xzmbWMMenuItem *)initialMenuItem atIndex:(NSInteger)index;

@end

@interface zp02yx_xzmbWMMenuView : UIView <WMMenuItemDelegate>
@property (nonatomic, strong) NSArray *progressWidths;
@property (nonatomic, weak) zp02yx_xzmbWMProgressView *progressView;
...
- (zp02yx_xzmbWMMenuItem *)itemAtIndex:(NSInteger)index;
